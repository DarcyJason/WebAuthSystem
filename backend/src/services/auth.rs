...
use crate::{
    ...
    validation::auth::{
        validate_forget_password_payload, validate_login_payload, validate_refresh_tokens_payload,
        validate_register_payload, validate_reset_password_payload, validate_verify_user_payload,
    },
};
...
impl AuthService {
    ...
    pub async fn refresh_tokens(
        ...
        validate_refresh_tokens_payload(&payload)?;
        Ok(AppResponse::<()>::success(
            StatusCode::OK.as_u16(),
            "Refresh your tokens successfully",
            StatusCode::OK.canonical_reason().unwrap_or("OK"),
            None,
        ))
    }
