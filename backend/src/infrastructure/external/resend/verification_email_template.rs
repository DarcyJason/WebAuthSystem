            ...
            <tr>
              <td align="center">
                <table width="520" cellpadding="0" cellspacing="0"
                  ...
                  <tr>
                    <td style="font-size:16px;color:#4b5563;line-height:1.6;">
                      <h2 style="font-size:20px;color:#111827;margin-top:0;">Reset your password</h2>
                      Hello <strong>{user_email}</strong>,<br/>
                      Please use the password reset token below to complete your password reset.
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="font-size:14px;color:#6b7280;line-height:1.7;">
                      Note: This token will expire in <strong>{expires_minutes} minutes</strong>.
